...
const IncomingDocumentTypes = ({
  ...
  const documentTypes = React.useMemo(
    () => [
      ...
      'Externally Funded Projects (Monthly/Yearly)',
      'Externally Funded Projects (Terminal Report)',
      'Legal Matters - Answer to Suspension',
      'Legal Matters - Appeal Memo',
      'Legal Matters - Ombudsman',
      'Request - Write Off',
      'Request - Others',
      'Request - Documents',
...
export default IncomingDocumentTypes
